...
const char * V_SLOCAL_REVISION="132";
const char * V_SREVISION="492b8e6318fe";
const char * V_STAG="2022.12 +132";
...
const uint32_t V_REVISION_0=0x492b8e63;
const uint16_t V_REVISION_1=0x18fe;
